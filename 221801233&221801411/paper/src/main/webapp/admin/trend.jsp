                ...
                option = {
                    ...
                    series: [
                        ...
                        },
                        {
                            ...
                            type: 'line',
                            stack: '总量',
                            data: [320, 332, 301, 334, 390, 330, 320,352,251,213]
                        },
                        {
                            name: '热词5',
                            type: 'line',
                            stack: '总量',
                            data: [820, 932, 901, 934, 1290, 1330, 1320,556,563,672]
                        },
                        {
                            name: '热词6',
                            type: 'line',
                            stack: '总量',
                            data: [111,223,332,114,452,241,361,271,284,182,276,231]
                        },
                        {
                            name: '热词7',
                            type: 'line',
                            stack: '总量',
                            data: [231, 109, 189, 243, 279, 356, 308,221,245,321,312]
                        },
                        {
                            name: '热词8',
                            type: 'line',
                            stack: '总量',
                            data: [142, 242, 101, 144, 199, 350, 420,231,341,234,213]
                        },
                        {
                            name: '热词9',
                            type: 'line',
                            stack: '总量',
                            data: [330, 352, 332, 345, 360, 370, 310,346,299,301,404]
                        },
                        {
                            name: '热词10',
                            type: 'line',
                            stack: '总量',
                            data: [876, 962, 911, 934, 1321, 1350, 1320,1249,1423,1332]
                        }
                    ]
                    // toolbox: {
                    //     feature: {
