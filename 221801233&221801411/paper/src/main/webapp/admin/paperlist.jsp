        ...
        <div class="ui stackable grid">
            ...
            <div class="four wide column">
                ...
                <div class="ui segments">
                    ...
                    <div class="ui blue segment">
                        <a href="GraphServlet" class="ui blue basic label my-marin-tb-tiny">Facial Landmark
                            <div class="detail">&emsp;文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic  label my-marin-tb-tiny">Surface
                            <div class="detail">"           "文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic  label my-marin-tb-tiny">3-D acition
                            <div class="detail">"       "文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic label my-marin-tb-tiny">Object motion
                            <div class="detail">"     "文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic  label my-marin-tb-tiny">Face detection
                            <div class="detail">"    "文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic  label my-marin-tb-tiny">Forward Passstereo
                            <div class="detail">文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic label my-marin-tb-tiny">video caption
                            <div class="detail">"     "文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic  label my-marin-tb-tiny">Image Retrieval
                            <div class="detail">"   "文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic  label my-marin-tb-tiny">Human parsing
                            <div class="detail">"     "文章数量</div>
                        </a>
                        <a href="GraphServlet" class="ui blue basic  label my-marin-tb-tiny">Face alignment
                            <div class="detail">"    "文章数量</div>
                        </a>
                    </div>
                </div>
