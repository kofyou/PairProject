            ...
            var option = {
                ...
                series: [{
                    ...
                    data: [
                        ...
                        { value:176,  url:"SearchServlet?id=114"},
                    ...
                    type: 'bar',
                    data: [
                        { value:389,  url:"SearchServlet?id=267"},
                    ...
                    type: 'bar',
                    data: [
                        { value:451,  url:"SearchServlet?id=273"},
                    ...
                    data: [
                        ...
                        { value:226, url:"SearchServlet?id=102"},

                    ]
                },{
                    name: 'Forward Passstereo',
                    type: 'bar',
                    data: [
                        { value:115,  url:"SearchServlet?id=290"},
                    ]
                },{
                    name: 'video caption',
                    type: 'bar',
                    data: [
                        ...
                        { value:68,  url:"SearchServlet?id=292"},
                    ...
                    data: [
                        ...
                        { value:97,  url:"SearchServlet?id=160"},
                    ...
                    type: 'bar',
                    data: [
                        { value:78,  url:"SearchServlet?id=938"},
                    ]
                },{
                    name: 'Face alignment',
                    type: 'bar',
                    data: [
                        ...
                        { value:54,  url:"SearchServlet?id=339"},
                    ]
                },]
            };
            // 使用刚指定的配置项和数据显示图表。
