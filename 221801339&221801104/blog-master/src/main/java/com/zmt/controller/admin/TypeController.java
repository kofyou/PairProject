package com.zmt.controller.admin;
...
public class TypeController {
    ...
    public String showInput(Model model){
        model.addAttribute("type",new com.zmt.po.Type());
    ...
    @PostMapping("/types")
    public String post(@Valid com.zmt.po.Type type, BindingResult result, RedirectAttributes attributes) {
        //1.判断用户名是有重复
        com.zmt.po.Type type1 = typeServiceImpl.getTypeByName(type.getName());
        if (type1 != null) {
        ...
        com.zmt.po.Type t = typeServiceImpl.saveType(type);
        if (t == null ) {
    ...
    public String editPost(@Valid com.zmt.po.Type type, BindingResult result, @PathVariable Long id, RedirectAttributes attributes) {
        com.zmt.po.Type type1 = typeServiceImpl.getTypeByName(type.getName());
        if (type1 != null) {
            result.rejectValue("name","nameError","不能添加重复的分类");
        }
