...
public class TagController {
   ...
   private TagService tagServiceImpl;
    ...
    public String showInput(Model model){
        model.addAttribute("tag",new com.zmt.po.Tag());
     ...
     */
    @PostMapping("/tags")
    public String post(@Valid com.zmt.po.Tag tag, BindingResult result, RedirectAttributes attributes) {
        com.zmt.po.Tag tag1 = tagServiceImpl.getTagByName(tag.getName());
        if (tag1 != null) {
        ...
        com.zmt.po.Tag t = tagServiceImpl.saveTag(tag);
        if (t == null) {
     ...
     */
    @PostMapping("/tags/{id}")
    public String editPost(@Valid com.zmt.po.Tag tag, BindingResult result, @PathVariable("id")Long id, RedirectAttributes attributes){
        com.zmt.po.Tag tag1 = tagServiceImpl.getTagByName(tag.getName());
        if (tag1 != null) {
