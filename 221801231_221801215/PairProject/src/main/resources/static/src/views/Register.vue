...
<div>
  ...
  <mymain>
    ...
    <div class="registerblock">
      ...
      <el-form ref="registerForm" :model="registerform" class="registerform" :rules="rules">
  ...
  if(!value)
  {
    return callback(new Error("请输入账号"));}
      ...
      if(validateAccountNumber(value)){
        ...
        return  callback(new Error('账号可包含中文、英文、数字但不包括下划线等特殊符号，长度为2-20'));
      }
  }
};
...
name: "Register",
 ...
 methods:{ registerForm(formName) {
     console.log(this.$md5(this.registerform.registerPassword));
     let _this = this;
     this.$axios.post(_this.$api.globalUrl + "/user/register", {
