$(function () {
  ...
  $.extend(Page.prototype, {
    init: function () {
      this.bindEvents();
      search = decodeURI(window.location.toString().split("&page=")[0].split("=").pop());
    ...
    toPage: function () {
      ...
      if (p > maxPage) {
        ...
        window.open("searchList.html?search=" + search + "&page=" + p, "_self");
    },
    lastPage: function () {
      if (thisPage != "1") {
        window.open(
