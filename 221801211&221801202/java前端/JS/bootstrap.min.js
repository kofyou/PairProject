...
!function (a) {
    ...
                    if (document.addEventListener)document.addEventListener("DOMContentLoaded", p, !1), a.addEventListener("load", r, !1); else if (document.attachEvent) {
    ...
                }
                return a
            }, u.apply(u, {version: "1.0", email: "taylor@ichartjs.com", isEmpty: function (a, b) {
    ...
                var d = {};
                if (u.isArray(a) && u.isObject(b))for (var e = 0; e < a.length; e++)d[a[e]] = c && u.isObject(b[a[e]]) ? u.clone(b[a[e]], c) : b[a[e]]; else if (u.isObject(a))for (var f in a)d[f] = b && u.isObject(a[f]) && !a[f].ICHARTJS_OBJECT ? u.clone(a[f], b) : a[f];
                return d
    ...
                }
            }();
            var v = Math.sin, w = Math.cos, x = Math.atan, y = (Math.tan, Math.acos, Math.sqrt), z = Math.abs, A = Math.PI, B = 2 * A, C = Math.ceil, D = Math.round, E = Math.floor, F = Math.max, G = Math.min, H = parseFloat, I = {}, J = {}, K = function (a, b) {
                if (0 == a)return a;
                var c = z(a), d = .1;
                if (c > 1) {
                    for (; c > 1;)c /= 10, d = 10 * d;
    ...
                return D(a * d + b) / d
            }, L = {white: "rgb(255,255,255)", green: "rgb(0,128,0)", gray: "rgb(80,80,80)", red: "rgb(255,0,0)", blue: "rgb(0,0,255)", yellow: "rgb(255,255,0)", black: "rgb(0,0,0)"}, M = function (a) {
    ...
            }, N = function (a) {
                var b = /rgb(\w∗),(\w∗),(\w∗)(\w∗),(\w∗),(\w∗)/.exec(a);
                if (b)return new Array(b[1], b[2], b[3]);
                if (b = /rgba(\w∗),(\w∗),(\w∗),(.∗)(\w∗),(\w∗),(\w∗),(.∗)/.exec(a))return new Array(b[1], b[2], b[3], b[4]);
                throw new Error("invalid colors value '" + a + "'")
            }, O = function (a, b, c) {
                u.isArray(a) && (b = a[1], c = a[2], a = a[0]), a /= 255, b /= 255, c /= 255;
                var d = F(F(a, b), c), e = G(G(a, b), c), f = d - e;
                if (0 == f)return new Array(0, 0, d);
                var g;
                return a == d ? g = (b - c) / f : b == d ? g = (c - a) / f + 2 : c == d && (g = (a - b) / f + 4), g *= 60, 0 > g && (g += 360), new Array(g, f / d, d)
            }, P = function (a) {
                if (!a)return a;
                if (a = a.replace(/\s/g, "").toLowerCase(), /^rgb[0−9]1,3,[0−9]1,3,[0−9]1,3[0−9]1,3,[0−9]1,3,[0−9]1,3$/.exec(a))return a;
                if (/^rgba[0−9]1,3,[0−9]1,3,[0−9]1,3,(0(\.\d∗)?|1(\.0)?)[0−9]1,3,[0−9]1,3,[0−9]1,3,(0(\.\d∗)?|1(\.0)?)$/.exec(a))return a;
                if (/^#(([a-fA-F0-9]{6,7})|([a-fA-F0-9]{3}))$/.exec(a))return M(a);
                if (L[a])return L[a];
                throw new Error("invalid colors value '" + a + "'")
            }, Q = function (a, b, c, d) {
                u.isArray(a) && (d = b, b = a[1], c = a[2], a = a[0]);
                var e, f, g, h = E(a / 60) % 6, i = a / 60 - h, j = c * (1 - b), k = c * (1 - b * i), l = c * (1 - b * (1 - i));
                switch (h) {
                    case 0:
                        e = c, f = l, g = j;
                        break;
    ...
            };
            return u.apply(u, {getFont: function (a, b, c, d) {
                return a + " " + b + (d || "px") + " " + c
            }, getDoc: function () {
    ...
                var e = u.quadrant(a, b, c, d), f = x(z((b - d) / (a - c)));
    ...
                if (a >= b)return[];
                var d = u.quadrantd(a), e = u.quadrantd(b);
                if ((2 == d || 3 == d) && (2 == e || 3 == e) && A > b - a)return[];
                if (a = u.toPI2(a), b = u.toPI2(b), a >= b && (b += B), a > A)a = B; else {
                    if (b > B)return[
                        {s: a, e: A, f: c},
                        {s: B, e: b, f: c}
                    ];
    ...
                return{x: a + w(c) * d, y: b + v(c) * d}
            }, toRgb: P, toRgba: function (a, b) {
                var c = N(P(a));
                return"rgba(" + c[0] + "," + c[1] + "," + c[2] + "," + b + ")"
            }, vectorP2P: function (a, b, c) {
                return c || (b = u.angle2Radian(b), a = u.angle2Radian(a)), b = v(b), {x: b * v(a), y: b * w(a)}
            }, uid: function (a) {
                return(a || "ichartjs") + "_" + C(1e4 * Math.random()) + (new Date).getTime().toString().substring(4)
            }, register: function (a) {
                if (u.isString(a))J[a.toLowerCase()] = a; else {
                    var b = a.get("id");
                    if (!b || "" == b) {
    ...
            }, emptyFn: function () {
                return!0
            }, ratio: a.devicePixelRatio || 1, supportCanvas: j, isOpera: e, isWebKit: g, isChrome: f, isSafari: h, isIE: i, isGecko: k, isMobile: l, touch: "ontouchend"in document, FRAME: l ? 30 : 60}), u.Assert = {isTrue: function (a, b) {
    ...
                    b(a)
                }
            }(), u.Event = {addEvent: function (a, b, c, d) {
    ...
                    } else for (; k != document.body && k;)i += k.offsetLeft - (k.scrollLeft || 0), j += k.offsetTop, k = k.offsetParent;
    ...
            this.type = "html", this.T = b, a.DefineAbstract("beforeshow", this), this.set({animation: !0, default_action: !0, width: 0, height: 0, style: "", index: 999, offset_top: 0, offset_left: 0}), this.transitions = ""
        }, initialize: function () {
            var a = this._();
    ...
            a.Component.superclass.configure.apply(this, arguments), this.type = "component", this.set({fontsize: 12, font: "Verdana", fontweight: "normal", fontunit: "px", tip: {enable: !1, border: {width: 2}}}), this.atomic = !1, this.proxy = !1, this.ICHARTJS_CHART = !1, this.inject(b)
        }, initialize: function () {
    ...
        }}), a.Tip = a.extend(a.Html, {configure: function () {
    ...
            a.CrossHair.superclass.configure.apply(this, arguments), this.type = "crosshair", this.set({top: 0, left: 0, hcross: !0, vcross: !0, invokeOffset: null, line_width: 1, line_color: "#1A1A1A", delay: 200})
    ...
            var b = this._(), c = a.toPixel(b.get("line_width"));
    ...
            var c = {valid: !1}, d = b.get("line_height");
            return a.x > this.x && a.x < b.x + b.width && a.y > b.y && a.y < b.y + b.height && b.data.each(function (e, f) {
                return a.x > e.x && a.x < e.x + e.width_ + b.get("signwidth") && a.y > e.y - d / 2 && a.y < e.y + d / 2 ? (c = {valid: !0, index: f, target: e}, !1) : void 0
            }, b), c
    ...
                }, c), a.isArray(k) && (g = k.length > g ? k.length : g), c.push("maxItemSize", g); else if ("stacked" == c.dataType || "complex" == c.dataType) {
    ...
                        f = c.value[r], (f || 0 == f) && (c.value[r] = f = o(f, f), m += f, q ? n = b[g].color : (n = c.color, h || (d = e = f, h = !0), d = i(f, d), e = j(f, e)), l.push(a.applyIf({name: c.name, value: c.value[r], background_color: n, color: n}, a.isArray(c.extra) ? c.extra[r] || {} : c)))
    ...
                d = m(k, d), e = m(k, e);
                var p = [];
                return 0 > e ? a.isObject(n[4]) && p.push(a.applyIf({points: [
                    {x: b, y: c - h},
                    {x: d, y: e - h},
                    {x: d + g, y: e - h},
                    {x: b + g, y: c - h}
                ]}, n[4])) : a.isObject(n[0]) && p.push(a.applyIf({points: [
                    {x: b, y: c},
                    {x: d, y: e},
                    {x: d + g, y: e},
                    {x: b + g, y: c}
                ]}, n[0])), a.isObject(n[1]) && p.push(a.applyIf({points: [
                    {x: d, y: e},
                    {x: d, y: e - h},
                    {x: d + g, y: e - h},
                    {x: d + g, y: e}
                ]}, n[1])), a.isObject(n[2]) && p.push(a.applyIf({points: [
                    {x: b, y: c},
                    {x: b, y: c - h},
                    {x: d, y: e - h},
                    {x: d, y: e}
                ]}, n[2])), a.isObject(n[3]) && p.push(a.applyIf({points: [
                    {x: b + g, y: c},
                    {x: b + g, y: c - h},
                    {x: d + g, y: e - h},
                    {x: d + g, y: e}
                ]}, n[3])), 0 > e ? a.isObject(n[0]) && p.push(a.applyIf({points: [
                    {x: b, y: c},
                    {x: d, y: e},
                    {x: d + g, y: e},
                    {x: b + g, y: c}
                ]}, n[0])) : a.isObject(n[4]) && p.push(a.applyIf({points: [
                    {x: b, y: c - h},
                    {x: d, y: e - h},
                    {x: d + g, y: e - h},
                    {x: b + g, y: c - h}
                ]}, n[4])), a.isObject(n[5]) && p.push(a.applyIf({points: [
                    {x: b, y: c},
                    {x: b, y: c - h},
                    {x: b + g, y: c - h},
                    {x: b + g, y: c}
    ...
                        if (!a.ICHARTJS_CHART) {
                            var d = a.variable.event, e = a.isMouseOver(b);
                            if (e.valid) {
    ...
                var g = !!b.get("communal_acting"), h = b.getPercent(c.value, c.total);
    ...
        }}), a.Scale = a.extend(a.Component, {configure: function () {
            a.Scale.superclass.configure.apply(this, arguments), this.type = "scale", this.set({position: "left", which: "h", basic_value: 0, scale2grid: !0, distance: void 0, start_scale: 0, end_scale: void 0, min_scale: void 0, max_scale: void 0, scale_space: void 0, scale_share: 5, scale_enable: !0, scale_size: 1, scale_width: 4, scale_color: "#333333", scaleAlign: "center", labels: [], label: {}, text_space: 6, textAlign: "left", decimalsnum: 0, join_style: "none", join_size: 2}), this.registerEvent("parseText")
        }, isEventValid: function () {
            return{valid: !1}
        }, getScale: function (b) {
    ...
            var b = this._(), c = Math.abs, d = b.get("labels").length, e = b.get("min_scale"), f = b.get("max_scale"), g = b.get("scale_space"), h = b.get("end_scale"), i = b.get("start_scale");
            if (b.items = [], b.labels = [], b.number = 0, d > 0)b.number = d - 1; else {
    ...
            var l, m, n, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = b.get("scale_width"), v = u / 2, w = b.get("scaleAlign"), x = b.get("position"), y = b.get("text_space"), z = "", A = b.get("coo").get("axis.width");
    ...
            for (var B = 0; B <= b.number; B++)l = d ? b.get("labels")[B] : (g * B + i).toFixed(b.get("decimalsnum")), m = b.isH ? b.get("valid_x") + B * b.get("distanceOne") : b.x, n = b.isH ? b.y : b.get("valid_y") + b.get("valid_distance") - B * b.get("distanceOne"), b.items.push({x: m, y: n, x0: m + q, y0: n + r, x1: m + o, y1: n + p}), b.get("label") && b.labels.push(new a.Text(a.applyIf(a.apply(b.get("label"), a.merge({text: l, x: m, y: n, originx: m + s, originy: n + t}, b.fireEvent(b, "parseText", [l, m + s, n + t, B, b.number == B]))), {textAlign: x, textBaseline: z}), b))
    ...
            var f = "85%", g = a.parsePercent, i = c.get("coordinate.scale"), j = c.push("coordinate._width", g(c.get("coordinate.width") || f, Math.floor(c.get("client_width"))));
            if (h = c.push("coordinate._height", g(c.get("coordinate.height") || f, Math.floor(c.get("client_height"))) - (c.is3D() ? (c.get("coordinate.pedestal_height") || 22) + (c.get("coordinate.board_deep") || 20) : 0)), c.push("coordinate.valid_height_value", g(c.get("coordinate.valid_height"), h)), c.push("coordinate.valid_width_value", g(c.get("coordinate.valid_width"), j)), c.originXY(c, [c.get("l_originx"), c.get("r_originx") - j, c.get("centerx") - j / 2], [c.get("centery") - h / 2]), c.set({coordinate: {originx: c.x, originy: c.y, id: "coordinate"}}), b && b(), a.isObject(i) && (i = [i]), a.isArray(i)) {
    ...
                })
            } else c.push("coordinate.scale", {position: e, scaleAlign: e, max_scale: c.get("maxValue"), min_scale: c.get("minValue")});
    ...
        }, doDraw: function (b) {
            if (b.T.box(b.x, b.y, b.width, b.height, 0, b.get("f_color")), b.get("striped"))var c, d, e = !1, f = (b.get("axis.width"), a.dark(b.get("background_color"), b.get("striped_factor"), 0));
    ...
                var y = i / x.value, z = x.value;
                "given_value" == x.way && (z = y, y = x.value, y = y > i ? i : y);
                for (var A = 0; z >= A; A++)p && b.gridlines.push(a.applyIf({overlap: q.call(b, "h", b.x + A * y, b.y), x1: b.x + A * y, y1: b.y, x2: b.x + A * y, y2: b.y + h, H: !1, width: t.width, color: t.color}, t))
            }
            if (f) {
                var B = b.get("grids.horizontal");
                a.Assert.isTrue(B.value > 0, "horizontal value");
                var y = h / B.value, z = B.value;
                "given_value" == B.way && (z = y, y = B.value, y = y > h ? h : y);
                for (var A = 0; z >= A; A++)p && b.gridlines.push(a.applyIf({overlap: q.call(b, "v", b.x, b.y + A * y), x1: b.x, y1: b.y + A * y, x2: b.x + i, y2: b.y + A * y, H: !0, width: s.width, color: s.color}, s))
            }
    ...
        }, doDraw: function (a) {
            var b = a.width, c = a.height, d = a.get("xAngle_"), e = a.get("yAngle_"), f = a.get("zHeight"), g = a.get("z_offx"), h = a.get("z_offy");
    ...
        }, isEventValid: function (b, c) {
            if (!c.get("ignored")) {
                if (c.isLabel() && c.label.isEventValid(b, c.label).valid)return{valid: !0};
                var d = a.distanceP2P(c.x, c.y, b.x, b.y), e = c.get("donutwidth");
                if (c.r < d || e && c.r - e > d)return{valid: !1};
                if (a.angleInRange(c.get("startAngle"), c.get("endAngle"), a.atan2Radian(c.x, c.y, b.x, b.y)))return{valid: !0}
            }
            return{valid: !1}
        }, tipInvoke: function () {
    ...
            if (b.push("inc_x", d * Math.cos(2 * Math.PI - c)), b.push("inc_y", d * Math.sin(2 * Math.PI - c)), d *= 2, b.get("label"))if (b.get("mini_label"))P2 = a.p2Point(b.x, b.y, c, b.get("donutwidth") ? b.r - b.get("donutwidth") / 2 : 5 * b.r / 8), b.doText(b, P2.x, P2.y); else {
    ...
            if (!c.get("ignored")) {
                if (c.isLabel() && c.label.isEventValid(b, c.label).valid)return{valid: !0};
                if (!a.inEllipse(b.x - c.x, b.y - c.y, c.a, c.b))return{valid: !1};
                if (a.angleZInRange(c.sA, c.eA, a.atan2Radian(c.x, c.y, b.x, b.y)))return{valid: !0}
            }
            return{valid: !1}
    ...
            if (b.sA = f.call(b, b.get("startAngle")), b.eA = f.call(b, b.get("endAngle")), b.mA = f.call(b, d), b.push("inc_x", g * Math.cos(e - b.mA)), b.push("inc_y", g * Math.sin(e - b.mA)), g *= 2, b.get("label"))if (b.get("mini_label")) {
    ...
                var b, c, d, e = [], f = [], g = a.get("layout_distance");
    ...
        }}), a.register("Donut2D"), a.Column = a.extend(a.Chart, {configure: function () {
    ...
                var d, e = b.data.length, f = b.get("coordinate.valid_width_value");
    ...
                var c, d = b.data.length, e = b.get("coordinate.valid_height_value");
    ...
        }}), a.register("Bar2D"), a.BarMulti2D = a.extend(a.Bar, {configure: function () {
    ...
        }}), a.register("BarMulti2D"), a.BarStacked2D = a.extend(a.Bar, {configure: function () {
    ...
        }}), a.register("BarStacked2D"), a.LineSegment = a.extend(a.Component, {configure: function () {
    ...
                return h = d.tipPosition < 3 && h - e - a - b > 0 || d.tipPosition > 2 && 0 > h - e - a - b ? h - (e + b) : h + b, i = 0 == d.tipPosition % 2 ? i + c : i - f - c, {left: h, top: i}
            }
    ...
                if (j && !j.isEventValid(c, j).valid)return{valid: !1};
                var e = Math.floor((c.x - b.x) / d);
                if (0 > e || e >= h.length - 1)return e = a.between(0, h.length - 1, e), m(h[e], c.x, c.y) ? n(e) : {valid: l};
    ...
            var b = this._(), c = 1 == b.data.length;
    ...
                {position: b.get("scaleAlign"), max_scale: b.get("maxValue")},
                {position: b.get("labelAlign"), start_scale: 1, scale: 1, end_scale: b.get("maxItemSize"), labels: b.get("labels"), label: b.get("label")}
            ])), b.coo = a.Coordinate.coordinate_.call(b), b.Combination && (b.coo.push("crosshair", b.get("crosshair")), b.coo.doCrosshair(b.coo)), !b.isE()) {
                var e = b.coo.valid_width, f = e, g = b.get("maxItemSize") - 1, h = e / g, i = b.get("point_space");
    ...
                    r && delete b.get("tip.listeners").parseText, b.mocker = new a.Custom({eventValid: function (a) {
    ...
            var b = this._();
            if (!b.isE()) {
                var c, d, e, f, g, h, i = b.coo.valid_height, j = b.get("point_space"), k = b.get("sub_option.originx");
